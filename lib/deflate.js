import { deflate as deflateDo, deflateInit2, deflateEnd, deflateSetHeader, deflateSetDictionary } from './zlib/deflate';
import { shrinkBuf, flattenChunks } from './utils/common';
...
class Deflate {
  ...
  push(data, mode) {
    ...
    do {
      ...
      status = deflateDo(strm, _mode);    /* no bad return value */
